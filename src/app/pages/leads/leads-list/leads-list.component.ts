...
import { Component, QueryList, ViewChildren, Input ,TemplateRef } from '@angular/core';
...
import { NgbdOrdersSortableHeader, orderSortEvent } from './leads-sortable.directive';
...
export class LeadsListComponent {
  ...
  // Table data
  ordersList!: Observable<LeadsModel[]>;
  total: Observable<number>;
  @ViewChildren(NgbdOrdersSortableHeader) headers!: QueryList<NgbdOrdersSortableHeader>;

  constructor(private offcanvasService: NgbOffcanvas,private modalService: NgbModal, public service: LeadsService, private formBuilder: UntypedFormBuilder, private restApiService: restApiService, private datePipe: DatePipe) {
